...
fft.writeSpectrumLogScaled("image/mandrilLowPassSpectrum.png")
fft.writePhase("image/mandrilLowPassPhase.png")

# Inverse the transformation back to spatial domain
fft.getInverse()
    
# Save the filtered image
im.write("image/mandrilFiltered.png")